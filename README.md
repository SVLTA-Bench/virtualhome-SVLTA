...
**Note:** If you want to generate your own Synthetic Visual-Language Temporal Alignment Benchmark, you need to pay attention to these functions and parameters in `./simulation/unity_simulator/comm_unity.py`.
